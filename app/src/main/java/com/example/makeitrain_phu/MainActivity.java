package com.example.makeitrain_phu;
        ...
        switch (moneyCounter) {
            case 20000:
                moneyValue.setTextColor(ContextCompat.getColor(MainActivity.this,
                        R.color.purple_700));
                Toast.makeText(this, "You're getting rich",
                        Toast.LENGTH_SHORT).show();
                break;
            case 30000:
                moneyValue.setTextColor(Color.MAGENTA);
                Toast.makeText(this, "You're getting richer",
                        Toast.LENGTH_SHORT).show();
                break;

            case 40000:
                moneyValue.setTextColor(Color.RED);
                Toast.makeText(this, "You're really rich",
                        Toast.LENGTH_SHORT).show();
                break;
            default:
